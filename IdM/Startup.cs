...
[assembly: OwinStartupAttribute(typeof(IdM.Startup))]
namespace IdM
{
    public partial class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            app.Map("/idm", idm =>
            {
                ...
                //factory.Register(new Registration<ApplicationDbContext>(resolver => new ApplicationDbContext("idMgrConnString")));
